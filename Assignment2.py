#I have played around with the values and functions and have increased the accuracy by about 3-4%
'''
...
from keras.layers.advanced_activations import LeakyReLU, PReLU # just messing around here
print()
'''
********************************************************************************************
...
print('**************')
print()
(x_train, y_train), (x_test, y_test) = reuters.load_data(num_words=max_words,seed=45,test_split=0.1)
'''
********************************************************************************************
...
model.add(Dropout(0.65)) #increased dropout to 65%
model.add(Dense(num_classes))
model.add(Activation('sigmoid')) #Modified activation to sigmoid
'''
